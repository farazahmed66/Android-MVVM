package com.eateasily.codewars.data.remote.dto
...
@JsonClass(generateAdapter = true)
data class RanksDto(
    @field:Json(name = "overall") val overall: OverallDto,
    @field:Json(name = "languages") val languages: Map<String, OverallDto>
)
